    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                if (!process.env.TOKEN_SECRET) return [3 /*break*/, 2];
                try {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                return [4 /*yield*/, manager.create(user)];
            case 1:
                newUser = _a.sent();
...
var authenticate = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, manager.authenticate({ id: 0, first_name: req.body.first_name, last_name: req.body.last_name, password: req.body.password })];
            case 1:
                user = _a.sent();
                if (process.env.TOKEN_SECRET) {
...
var destroy = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 2:
                err_4 = _a.sent();
                res.status(400).send("Couldn't delete a user with id ".concat(req.body.id, " Error: ").concat(err_4));
                return [3 /*break*/, 3];
            case 3: return [2 /*return*/];
        }
    });
