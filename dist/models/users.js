...
var User_Manager = /** @class */ (function () {
    function User_Manager() {
        this.pepper = 'this is default';
        this.saltings = '10';
    ...
    User_Manager.prototype.index = function () {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        err_1 = _a.sent();
                        throw new Error("Cannot get users results ".concat(err_1));
    ...
    User_Manager.prototype.create = function (pd) {
        return __awaiter(this, void 0, void 0, function () {
            var connect, query1, chk, hash, query, result, err_3;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 4, , 5]);
                    ...
                    case 2:
                        ...
                        hash = bcrypt_1.default.hashSync(pd.password + this.pepper, parseInt(this.saltings));
                        query = "INSERT INTO users(first_name, last_name, password) VALUES($1,$2,$3) RETURNING *";
                        return [4 /*yield*/, connect.query(query, [pd.first_name, pd.last_name, hash])];
                    case 3:
                        result = _a.sent();
                        connect.release();
    ...
    User_Manager.prototype.delete = function (id) {
        return __awaiter(this, void 0, void 0, function () {
            var connect, query, query2, result, err_4;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 4, , 5]);
                    ...
                    case 2:
                        _a.sent();
                        return [4 /*yield*/, connect.query(query2, [id])];
                    case 3:
                        result = _a.sent();
                        connect.release();
                        return [2 /*return*/, result.rows[0]];
                    case 4:
                        err_4 = _a.sent();
                        throw new Error("Cannot delete users with id = ".concat(id, " Error: ").concat(err_4));
                    case 5: return [2 /*return*/];
                }
            });
        });
    };
    User_Manager.prototype.authenticate = function (u) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, connect.query(query, [u.first_name])];
                    case 2:
                        result = _a.sent();
                        ...
                        if (!bcrypt_1.default.compareSync(u.password + this.pepper, result.rows[0].password)) {
                            connect.release();
                    ...
                    case 3:
                        err_5 = _a.sent();
                        throw new Error("Cannot authenticate user Error: ".concat(err_5));
                    case 4: return [2 /*return*/];
                }
            });
        });
